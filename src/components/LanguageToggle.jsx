  ...
  return (
    <div className="fixed left-4 bottom-4 z-50">
      <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
        ...
        <a
          href="http://instagram.com/atillakz/"
          target="_blank"
          rel="noopener noreferrer"
          className="group flex items-center justify-center bg-black/20 hover:bg-black/40 backdrop-blur-sm text-white p-2 rounded-full transition-all duration-300 w-10 h-10"
        >
          <svg 
